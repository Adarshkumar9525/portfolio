...
import { Mail, Phone, MapPin, Github, Linkedin, Send, Check, Copy, MessageSquare } from 'lucide-react';
...
export default function Contact() {
  ...
  return (
    <section id="contact" className="py-24 relative overflow-hidden bg-radial-grid">
          ...
          >
            <div className="p-6 rounded-3xl glass-card space-y-6">
              ...
              <div className="pt-4 border-t border-slate-200 dark:border-slate-800/80">
                <div className="text-xs font-mono text-slate-500 dark:text-slate-400 mb-3">Professional Profiles:</div>
                <div className="grid grid-cols-2 gap-3">
                  <a
                    href={portfolioData.personal.github}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="p-3 rounded-xl bg-slate-50 dark:bg-slate-900/80 border border-slate-200 dark:border-slate-800 hover:border-cyan-500/40 hover:text-cyan-600 dark:hover:text-cyan-400 text-slate-700 dark:text-slate-300 flex items-center gap-2.5 text-xs font-semibold transition-all shadow-sm"
                  >
